...
5. **Notify** — send a single daily digest message (not yet implemented).
...
Generated markdown files (`titles.md`, `articles.md`, `shortlisted_titles.md`, `shortlisted_articles.md`) are pipeline artifacts passed between steps, not source. `titles.md` and `test.ipynb` are gitignored.
